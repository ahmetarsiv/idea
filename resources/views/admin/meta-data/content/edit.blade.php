                ...
                <div class="col-12 col-lg-6">
                    <form name="form-data" enctype="multipart/form-data">
                        ...
                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="title" value="{{ $meta_content->title }}">
                            <label for="floatingFirst">Başlık</label>
                        </div>

                        <div class="form-floating mb-3">
                            <input type="text" class="form-control" name="slug" value="{{ $meta_content->slug }}">
                        ...
                        <div class="form-floating mb-3">
                            <select class="form-select" name="target">
                                ...
                                <option value="_self" {{$meta_content->target == '_self' ? 'selected' : null}}>Aynı
                                </option>
                                <option value="_blank" {{$meta_content->target == '_blank' ? 'selected' : null}}>Yeni
                                    Sekme
                                </option>
                            </select>
                        ...
                        <div class="form-check form-switch fs-3">
                            <input class="form-check-input" type="checkbox" id="flexSwitchCheckChecked" value="0"
                                   name="status" {{$meta_content->status == '1' ? 'checked' : null}}>
                        </div>
...
@section('js')
    <script>
        const actionUrl = '{{route('admin.meta-content.update',$meta_content)}}';
